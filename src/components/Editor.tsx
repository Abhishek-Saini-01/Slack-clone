...
const Editor = ({
    ...
    return (
        <div className="flex flex-col">
            ...
            />
            <div className={cn(
                "flex flex-col border border-slate-200 focus-within:border-slate-300 focus-within:shadow-sm transition bg-white rounded-md overflow-hidden",
                disabled && "opacity-50"
            )}>
                ...
                {!!image && (
                    <div className="p-2">
                        <div className="relative size-[62px] flex items-center justify-center group/image">
                            <Hint label="Remove" align="center" side="right">
                                <button
                                    onClick={() => {
                                        setImage(null);
